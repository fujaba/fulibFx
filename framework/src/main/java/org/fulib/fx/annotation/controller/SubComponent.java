 ...
 * <p>
 * When a subcomponent is specified in the fxml, the framework will look for any component field annotated with {@link SubComponent}.
 * If a matching field is found, the instance will be used as the subcomponent.
 * If no matching field is found, the framework will look for any provider field annotated with {@link SubComponent}.
 */
